function pesquisar() {
    ...
    if (!campoPesquisa) {
        section.innerHTML = "<p>Nada foi encontrado seu Puto<p>"
        return
    }
    ...
    for (let dado of dados) {
      ...
      // utilizando template literals para facilitar a criação de strings multi-linha
      
  
    // Atribui o HTML gerado ao elemento da seção
